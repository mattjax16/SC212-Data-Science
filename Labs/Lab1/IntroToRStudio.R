...
### ADDING MY OWN 3D plot with the classic iris dataset
# install.packages("rgl") # run this if you do not have rgl installed
# to get it to work on mac you will need Xquartz
library("rgl")
...
plot3d(x=iris$Sepal.Length, y=iris$Petal.Length, z=iris$Sepal.Width, 
       col = iris$color, 
       main = "Iris data",
       type = 's', 
       radius = .1,
...
## here is a really interesting use of 3d plotting I found 
...
# importing library for spacial data
library(sp)
library(xlsx)
district_name = read.xlsx2('/Users/matthewbass/Documents/School_Colby/Colby/spring22/SC212/Labs/Lab1/data/District\ Name.xlsx',1)
population = read.xlsx2('/Users/matthewbass/Documents/School_Colby/Colby/spring22/SC212/Labs/Lab1/data/Population\ Data.xlsx',1)
colnames(population) = c("Chi_name", "Population")

hkmap = readRDS("/Users/matthewbass/Documents/School_Colby/Colby/spring22/SC212/Labs/Lab1/data/HKG_adm1.rds") # geo data of HK map
...
ggsave('/Users/matthewbass/Documents/School_Colby/Colby/spring22/SC212/Labs/Lab1/results/map_bg.png', width = diff(xlim)*40, height = diff(ylim)*40, units = "cm")
...
# Real Estate Dataset
estate_df = read.csv('/Users/matthewbass/Documents/School_Colby/Colby/spring22/SC212/Labs/Lab1/data/real_estate_master_df.csv')
...
# Importing data with file.chose
surveydata<- read.csv(file = file.choose())
head(surveydata)
...
mean(BaseballHits2019$HomeRuns)
